...
config :provider, ProviderWeb.Endpoint,
  ...
  live_view: [signing_salt: "idHzzPcq"]
...
config :provider, ExOauth2Provider,
  repo: Provider.Repo,
  resource_owner: Provider.Accounts.User

config :ex_oauth2_provider, ExOauth2Provider, repo: Provider.Repo
